...
import com.sjet.auracascade.common.tiles.consumer.AuraFurnaceTile;
...
public class AuraFurnace extends BaseAuraConsumer {

    @ObjectHolder(AuraCascade.MODID + ":aura_furnace")
    public static final AuraFurnace BLOCK = null;
    ...
    public AuraFurnace() {
        ...
        setRegistryName(AuraCascade.MODID, "aura_furnace");
    }

    @Override
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new AuraFurnaceTile();
    }
